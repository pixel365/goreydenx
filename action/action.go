...
func request(c rx.RxClient, path string) (*m.ActionResult, error) {
...
func TaskStatus(c rx.RxClient, orderId uint32, taskId string) (string, error) {
...
func Run(c rx.RxClient, orderId uint32) (*m.ActionResult, error) {
...
func Stop(c rx.RxClient, orderId uint32) (*m.ActionResult, error) {
...
func Cancel(c rx.RxClient, orderId uint32) (*m.ActionResult, error) {
...
func ChangeOnline(c rx.RxClient, orderId uint32, value uint32) (*m.ActionResult, error) {
...
func ChangeIncreaseValue(c rx.RxClient, orderId uint32, value uint32) (*m.ActionResult, error) {
...
func IncreaseOn(c rx.RxClient, orderId uint32, value uint32) (*m.ActionResult, error) {
...
func IncreaseOff(c rx.RxClient, orderId uint32) (*m.ActionResult, error) {
...
func AddViews(c rx.RxClient, orderId uint32, value uint32) (*m.ActionResult, error) {
...
func ChangeLaunchMode(
	c rx.RxClient,
	orderId uint32,
	params *m.LaunchParameters,
	...
	res, err := c.Patch(
		fmt.Sprintf("/orders/%d/action/change/launch/", orderId),
