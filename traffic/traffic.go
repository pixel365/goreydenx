...
func Countries(c rx.RxClient) (*m.Result[[]m.Traffic], error) {
...
func Languages(c rx.RxClient) (*m.Result[[]m.Traffic], error) {
...
func Devices(c rx.RxClient) (*m.Result[[]m.Traffic], error) {
