...
func request(c rx.RxClient, platform rx.PlatformCode) (*m.Result[[]m.Price], error) {
...
func Twitch(c rx.RxClient) (*m.Result[[]m.Price], error) {
	return request(c, rx.Twitch)
}

// YouTube All prices for YouTube
// See https://api.reyden-x.com/docs#/Prices/prices_v1_prices__platform_code___get
func YouTube(c rx.RxClient) (*m.Result[[]m.Price], error) {
	return request(c, rx.YouTube)
}

// Trovo All prices for Trovo
// See https://api.reyden-x.com/docs#/Prices/prices_v1_prices__platform_code___get
func Trovo(c rx.RxClient) (*m.Result[[]m.Price], error) {
	return request(c, rx.Trovo)
}

// GoodGame All prices for GoodGame
// See https://api.reyden-x.com/docs#/Prices/prices_v1_prices__platform_code___get
func GoodGame(c rx.RxClient) (*m.Result[[]m.Price], error) {
	return request(c, rx.GoodGame)
}

// VkPlay All prices for VkPlay
// See https://api.reyden-x.com/docs#/Prices/prices_v1_prices__platform_code___get
func VkPlay(c rx.RxClient) (*m.Result[[]m.Price], error) {
	return request(c, rx.VkPlay)
}

// Kick All prices for Kick
// See https://api.reyden-x.com/docs#/Prices/prices_v1_prices__platform_code___get
func Kick(c rx.RxClient) (*m.Result[[]m.Price], error) {
	return request(c, rx.Kick)
}

// Categories All price categories
// See https://api.reyden-x.com/docs#/Price%20Categories/categories_v1_price_categories__get
func Categories(c rx.RxClient) (*m.Result[[]m.PriceCategory], error) {
